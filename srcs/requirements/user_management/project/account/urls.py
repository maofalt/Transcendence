...
urlpatterns = [
    ...
    path("api/validate_username", views.validate_username_view, name="validate_username"),
    path("api/validate_email", views.validate_email_view, name="validate_email"),
     path("api/validate_playername", views.validate_player_name_view, name="validate_playername"),
    path("api/validate_password", views.validate_password_view, name="validate_password"),
