# Generated by Django 5.0.4 on 2024-04-05 00:51
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='matchsetting',
            name='ball_color',
            field=models.CharField(default='0x000000', max_length=7, validators=[django.core.validators.RegexValidator('^#(?:[0-9a-fA-F]{3}){1,2}$', message='Invalid color format.')]),
        ),
    ]
