    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tournament_type', models.CharField(choices=[('Knock-out', 'Knock-Out'), ('League', 'Round Robin')], default='Knock-out', max_length=15)),
                ('registration', models.CharField(choices=[('Public', 'Open game'), ('Private', 'Invitation required')], default='Public', max_length=15)),
