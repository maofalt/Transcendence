    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('settings', models.ForeignKey(default=0, on_delete=django.db.models.deletion.PROTECT, to='manage_tournament.matchsetting')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('match_setting_id', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='matches', to='manage_tournament.matchsetting')),
                ('participants', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='match_participants', to='manage_tournament.matchparticipants')),
        ...
        migrations.AddField(
            ...
            name='match_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='match_participants', to='manage_tournament.tournamentmatch'),
        ),
        migrations.AddField(
            model_name='tournament',
