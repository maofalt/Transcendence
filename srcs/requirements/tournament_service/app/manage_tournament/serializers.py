...
class Matchsettingerializer(serializers.ModelSerializer):
    class Meta:
        model = MatchSetting
        fields = fields = '__all__'

class TournamentSerializer(serializers.ModelSerializer):
    setting = Matchsettingerializer()
    is_full = serializers.SerializerMethodField()

    class Meta:
        model = Tournament
        fields = ['tournament_name', 'nbr_of_player_total', 'nbr_of_player_match', 'game_type', 'tournament_type', 'registration', 'setting', 'registration_period_min', 'host_id', 'is_full' ]
