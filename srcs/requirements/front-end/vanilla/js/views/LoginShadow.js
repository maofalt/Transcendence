...
export default class LoginPage extends HTMLElement {
    ...
    connectedCallback() {
        console.log('LoginShadow connectedCallback() called\n\n');
        ...
        if (accessToken) {
            ...
            //     this.profilePageContainer.innerHTML = '';
			// 	const profilePage = new ProfilePage();
			// 	console.log('ProfilePage:', profilePage);
            //     this.profilePageContainer.appendChild(profilePage);
    ...
    updateLoggedInUserUI(userProfile) {
        ...
        if (userProfile) {
            const profilePage = new ProfilePage();
            this.appendChild(profilePage);
            // Create userProfileElement if it doesn't exist
            let userProfileElement = document.getElementById('userProfile');
            ...
            // Create container for avatar, username, and logout button
            const userContainer = document.createElement('div');
            userContainer.style.display = 'flex'; // Use flexbox layout
            userContainer.style.alignItems = 'center'; // Align items vertically
            userProfileElement.appendChild(userContainer);
    
            // Create container for avatar image and username (on the left)
            const leftContainer = document.createElement('div');
            leftContainer.style.display = 'flex'; // Use flexbox layout
            leftContainer.style.alignItems = 'center'; // Align items vertically
            leftContainer.style.marginRight = 'auto'; // Pushes it to the left
            userContainer.appendChild(leftContainer);
            ...
            // Display user's playername
            const playerNameElement = document.createElement('span');
            playerNameElement.textContent = userProfile.playername;
            leftContainer.appendChild(playerNameElement);
    
            // Create container for logout button (on the right)
            const rightContainer = document.createElement('div');
            rightContainer.style.marginLeft = 'auto'; // Pushes it to the right
            userContainer.appendChild(rightContainer);
            ...
            // Add line break
            userProfileElement.appendChild(document.createElement('br'));
    
            // Show "Show Profile" link
            const showProfileLink = document.createElement('a');
            showProfileLink.textContent = 'Show Profile';
            showProfileLink.href = '#'; 
            showProfileLink.addEventListener('click', (event) => {
                event.preventDefault();
                navigateTo('/profile');
            });
            userProfileElement.appendChild(showProfileLink);
            userProfileElement.appendChild(document.createElement('br'));
    
            // Show "Game History" link
            const gameHistoryLink = document.createElement('a');
            gameHistoryLink.textContent = 'Game History';
            gameHistoryLink.href = '/api/user_management/auth/gameHistory'; // Assuming this is the URL for the game history page
            userProfileElement.appendChild(gameHistoryLink);
            userProfileElement.appendChild(document.createElement('br'));
    
            // Show "Account Settings" link
            const accountSettingsLink = document.createElement('a');
            accountSettingsLink.textContent = 'Account Settings';
            accountSettingsLink.href = '/api/user_management/auth/settings'; // Assuming this is the URL for the account settings page
            userProfileElement.appendChild(accountSettingsLink);
        }
    }
